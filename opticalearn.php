...
<html>
    ...
    <body class="bodyclass">
        ...
        <form id="adform" onsubmit="return testerror();" action="process_admission_form.php" method="post">
            <div class="container">  
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 right-an">
                        <input class="focus-error inputclass col-lg-12 border-1 mt-3 bg-transparent" type="file" id="fle"><!-- comment -->
